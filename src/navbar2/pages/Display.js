    ...
    <div className='relative'>
      ...
      <div className='md:pt-8 pt-4 flex justify-center'>
        <div className='md:w-10/12 p-1'>
          ...
          <div onClick={DownloadCv}  className='text-center cursor-pointer flex justify-center p-3 rounded-xl bg-green-400'>
            <div className='animate-bounce'><svg  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={3} stroke="white" className="w-10 h-10">
            <path strokeLinecap="round" strokeLinejoin="round" d="M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5M16.5 12L12 16.5m0 0L7.5 12m4.5 4.5V3" />
          </svg></div>
            <div className='font-bold text-xl text-neutral-700'>Developer's CV</div>
            </div>
        </div>
      </div>
