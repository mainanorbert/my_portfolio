...
const Display=()=> {
  ...
  return (
    ...
    <motion.div className='absolute top-[16rem] left-[4rem] text-left flex justify-start text-3xl font-bold text-white'
        initial={{ x: 0 }} // Initial position of the word
        animate={{ x: 400 }} // Animation position
        transition={{ duration: 10, repeat: Infinity }} // Animation duration and repeat
      ...
      >
        ...
        <Typewriter
    onInit={(typewriter)=>{
      typewriter.typeString('Technology is our Goal').start();
    }}
    options={{
      // strings:["Absolute"],
      autoStart:true,
