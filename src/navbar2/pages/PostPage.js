  ...
  return (
    <div className='flex justify-center'>
      <div className='md:w-6/12 bg-slate-400'>
        <div className='text-center font-bold text-xl '>{post.title}</div>
        <div className=' w-10/12'>
          <div>{deleteMessage}</div>
          <div className='bg-slate-500 hover:bg-slate-600 mx-1 cursor-pointer hover:text-neutral-300 text-xs rounded p-1  inline-block'>
        ...
        <div className='bg-slate-00 p-2 border-dotted border-2'> 
        ...
        <div className='p-1'>Norbert Osiemo is a fervent advocate of web development, possessing adeptness
